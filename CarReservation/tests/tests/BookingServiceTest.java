...
public class BookingServiceTest {
	...
	public void setUp() {
		...
		resourceService.addResource(new Resource("Resource1"));
		resourceService.addResource(new Resource("Resource2"));
	}
	...
	public void isGermanBookingRendered() {
		// Sprache Deutsch
		bookingService.createBooking("DE", "1", "person1", "Resource1", 100.0);
	...
	public void isEnglishBookingRendered() {
		bookingService.createBooking("EN", "2", "person2", "Resource2", 200.0);
	...
	public void isBookingDeletedAndLookupFails() {
		bookingService.createBooking("DE", "3", "person1", "Resource1", 150.0);
		bookingService.createBooking("EN", "4", "person2", "Resource2", 250.0);
	...
	public void isBookingFooterLocalized() {
		bookingService.createBooking("EN", "5", "person2", "Resource2", 300.0);
	...
	public void isDuplicateBookingIdRejected() {
		bookingService.createBooking("DE", "6", "person1", "Resource1", 350.0);
		try {
			bookingService.createBooking("EN", "6", "person2", "Resource2", 400.0);
